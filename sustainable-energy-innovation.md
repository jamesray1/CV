...
- Other innovations include energy, but can also be broader than it, such as life cycle assessment, carbon trading, and certification in supply chains. The use of scalable cryptographic technologies like Holochain can help to deliver these innovations globally and on a mainstream level, although careful design is needed to make data publicly verifiable through the use of IoT, measuring devices, and distribution of certification agencies or validation, e.g. with webs of trust (which could allow anyone to be validators of measuring devices and data) and sovereign accountable commons (a Holochain ecosystem concept, analogous to decentralised autonomous organisations). A guy called Federico spoke to me last night about his ideas for using LCA and emissions trading with blockchains. I was talking him into using Holochain instead. It would be interesting to see life cycle assessment, trading of greenhouse gas emissions and other mechanisms to conserve the environment with a common property rights approach, used with Holochain. With LCA you could track embodied energy, renewable and non-renewable resource usage and other environmental impact metrics, then use it for a global certification system for goods and services. With emissions trading having a global network with a happ would help to achieve an international market.
